...
public:
	...
	void on_enter()
	{
		...
		large_platform.shape.y = (float)large_platform.render_positon.y + 95;
		...
		small_platform_1.shape.y = (float)small_platform_1.render_positon.y +35+ img_platform_small.getheight() / 2;
		...
		small_platform_2.shape.y = (float)small_platform_2.render_positon.y + 35 + img_platform_small.getheight() / 2;
		...
		small_platform_3.shape.y = (float)small_platform_3.render_positon.y + 35 + img_platform_small.getheight() / 2;
